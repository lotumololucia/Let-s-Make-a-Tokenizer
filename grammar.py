...
# Grammar rules.
INITIAL_PUNCTUATION_TOKEN = INITIAL_PUNCTUATION_GROUP + ALPHA_PUNCTUATION_GROUP #una comilla o apóstrofe al inicio, seguida de letras y quizás puntuación
FINAL_PUNCTUATION_TOKEN = ALPHA_GROUP + FINAL_PUNCTUATION_GROUP #una o más letras seguidas de uno o más signos de puntuación
